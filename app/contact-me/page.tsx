...
const Page = () => {
  const [formData, setFormData] = useState<{name: string,phoneNumber: string,email: string,message: string}>({
    phoneNumber: "",
    email: "",
    message: "",
    name: "",
      ...
      <div className="grid md:grid-cols-2 gap-16 items-center relative overflow-hidden p-10 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-3xl max-w-6xl mx-auto bg-white text-[#333] my-6 font-[sans-serif] before:absolute before:right-0 before:w-[300px] before:bg-blue-400 before:h-full max-md:before:hidden">
        <div>
          ...
          <p className="text-sm text-gray-800 mt-3">
            Have a specific inquiry or looking to explore new opportunities? I
            got you covered.
          </p>
          <form>
            <div className="space-y-4 mt-8">
              ...
              <input
                ...
                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.533] outline-none h-"
              ></input>
            </div>
            <button
              type="button"
              className="mt-8 flex items-center justify-center text-sm w-full rounded px-4 py-2.5 font-semibold bg-teal-500 text-white hover:bg-teal-600"
              onClick={submitForm}
            >
              <svg
        ...
        <div className="z-10 relative h-full max-md:min-h-[350px]">
          <iframe
            src={`https://www.google.com/maps/embed/v1/place?key=${process.env.NEXT_PUBLIC_MY_PORTFOLIO}&q=Tulsi+Vihar&center=26.8940466,80.9962114&zoom=15`}
